...
- C, C++, C#
- java, scala, kotlin
- crystal (ruby like), nim (python like), go
- rust
...
* Side by side examples: http://hyperpolyglot.org/
* Same program in different langages: http://rosettacode.org/wiki/Rosetta_Code
