...
Interface web pour le mail
==========================

squirrelmail (old)
roundcube => https://www.normalesup.org/phare/roundcube/, https://quatramaran.salle-s.org/roundcube
...
- https://github.com/tsl0922/ttyd
  use xtermjs, better terminal emulation than shellinabox

- https://github.com/novnc/noVNC
  VNC client using HTML5 (WebSockets, Canvas) https://novnc.com
...
- corkscrew [last release 2007], proxytunnel [last release 2008]
  ...
  [Note: httptunnel can also be used to tunnel through proxies]

  Update: corkscrew is still active, cf https://news.ycombinator.com/item?id=21383765

- https://github.com/erebe/wstunnel
  Tunneling over websocket protocol - Static binary available
  eg: https://kirill888.github.io/notes/wireguard-via-websocket/
