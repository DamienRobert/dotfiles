...
#Note: Thor::Shell has helper methods to interact with the user:
#(Thor::Shell is included into Thor)
#  ask             no?               print_wrapped  set_color  terminal_width
#  error           print_in_columns  say            shell      with_padding  
#  file_collision  print_table       say_status     shell=     yes?          
#  Thor::LineEditor.readline("foo: ")
#  s=Thor::Shell::Color.new; s.ask("foo")
#  Automatic selection of the shell: Thor::Base.shell.new
