...
(gtk_accel_path "<Actions>/terminal-window/fullscreen" "<Shift>F11")
; (gtk_accel_path "<Actions>/terminal-window/read-only" "")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-5" "<Alt>5")
(gtk_accel_path "<Actions>/terminal-window/preferences" "<Shift>F12")
(gtk_accel_path "<Actions>/terminal-window/reset-and-clear" "<Primary><Shift>y")
...
(gtk_accel_path "<Actions>/terminal-window/reset" "<Primary><Shift>r")
...
(gtk_accel_path "<Actions>/terminal-window/show-toolbar" "<Shift>F9")
...
(gtk_accel_path "<Actions>/terminal-window/set-title" "<Shift>F8")
...
(gtk_accel_path "<Actions>/terminal-window/show-menubar" "<Shift>F10")
