" Vim syntax file
" Language: Markdown (sans bold et italique, ni de html)
...
"this was done by syntax/html.vim, but I need to put it since I don't
"source it. This allows to have spell highlighting at toplevel
...
" TODO: real nesting
syn match markdownListMarker "\%(\t\| \{0,4\}\)[-*+$!x?]\{1,3\}\%(\s\+\S\)\@=" contained
...
"Since I am not sourcing html.vim, I need to define some hilinks used in
"markdownlight
"Rem: markdownBold is not defined in markdownlight, but it will be in
"mymarkdown and kramdown
...
hi def link htmlCommentError       Error

let b:current_syntax = "markdownlight"
if main_syntax ==# 'markdown'
  unlet main_syntax
endif
