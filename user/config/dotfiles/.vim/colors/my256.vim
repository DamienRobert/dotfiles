...
"    + based on commit 37ea6aace110e1e70acb32a3ec6dc9b7ae9009bf
" Version:	3.4
...
" Lemon Chiffon: #FFFACD vs Lemon: #FFFFD7
...
if &g:background=="dark"
  call s:h("IndentGuidesEven",    { "bg": s:almostBlack })
else
  " call s:h("IndentGuidesEven",    { "bg": s:lemonfaint })
  hi IndentGuidesEven  guibg=#F2F2CC
  hi IndentGuidesOdd  guibg=#FFFACD
endif
" }}}
