#!/usr/bin/env bash
## https://news.ycombinator.com/item?id=13849128
...
## This script from https://gitlab.gnome.org/GNOME/vte/blob/master/perf/img.sh
## is more complex because it uses 'square blocks'
