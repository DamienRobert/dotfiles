...
#similar up to no permutation (meaning they differ from at most one letter)
...
#similar up to a permutation (meaning up to permuation they differ from at
#most one letter)
def similar(w1,w2)
...
#list of similar words to word (among words)
...
#check if done_file is indeed correct
#donew=get_words(done_file) (attention à enlever le .uniq! pour le test)
#p donew
